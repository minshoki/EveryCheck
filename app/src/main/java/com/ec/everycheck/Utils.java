...
public class Utils {
	...
	public static String getRegistrationId(Context context) {
		String reg_id = getSharedPreferences("PROPERTY_REG_ID", context);
		if (reg_id.isEmpty()) {
			Log.i("PROPERTY_REG_ID", "Registration not found.");
			return "";
		}

		if (getSharedPreferences("PROPERTY_APP_VERSION", context).isEmpty()) {
			Log.i("PROPERTY_APP_VERSION", "App version changed.");
			return "";
		}
		return reg_id;
	}
